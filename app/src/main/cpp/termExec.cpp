...
static void android_os_Exec_setPtyWindowSize(JNIEnv *env, jobject,
...
static void android_os_Exec_setPtyUTF8Mode(JNIEnv *env, jobject, jint fd, jboolean utf8Mode)
{
    struct termios tios{};
...
static const char *classPathName = "com/stephen/redfindemo/feature/terminal/Exec";
